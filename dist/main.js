...
let dimBg; // Declare dimBg outside the functions to make it accessible to both functions
...
function createDimBg() {
    dimBg = document.createElement('div'); // Assign dimBg here, so it's accessible in clearForm
    dimBg.style.display = 'none';
    dimBg.id = 'dimBg';
