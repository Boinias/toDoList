...
class newTask {
  ...
  function createTaskObj(folderName) {
    ...
    let correctFolder = _createFolderObject_js__WEBPACK_IMPORTED_MODULE_0__.folders.find(folder => folder.title == folderName);
