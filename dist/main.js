...
dimBg.addEventListener('click', () => {
  (0,_taskLogic_js__WEBPACK_IMPORTED_MODULE_4__.clearForm)();
})
...
taskForm.addEventListener('submit', (e) => {
  ...
  (0,_taskLogic_js__WEBPACK_IMPORTED_MODULE_4__.addTask)();
  } else if (_mainDisplayElements_js__WEBPACK_IMPORTED_MODULE_3__.formStatus == 'edit task') {
    (0,_taskLogic_js__WEBPACK_IMPORTED_MODULE_4__.editTask) ()
  }
})
...
function createAddTaskBtn () {
    ...
    addTaskBtn.addEventListener('click', () => {  
        ...
        ;(0,_taskLogic_js__WEBPACK_IMPORTED_MODULE_1__.displayNewTaskForm)();
    });
...
correctObj.tasks.forEach(task => {
    ...
    taskCompleteBtn.addEventListener('click', (e)=> {
        (0,_taskLogic_js__WEBPACK_IMPORTED_MODULE_1__.taskComplete)(e, task);
        displayTaskComplete(task, _taskLogic_js__WEBPACK_IMPORTED_MODULE_1__.taskComplete);
    });
    ...
    editBtn.addEventListener('click', (e) => {
        ...
        (0,_taskLogic_js__WEBPACK_IMPORTED_MODULE_1__.displayEditTaskForm)(e);
        // bring up form
    })
