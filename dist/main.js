...
class newTask {
  ...
  function createTaskObj(openFolder) {
    ...
    localStorage.setItem('tasks', JSON.stringify(_createFolderObject_js__WEBPACK_IMPORTED_MODULE_0__.folders));
  }
